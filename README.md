...
Throws this error which I don't know how to fix: 	
Error	1	Inconsistent accessibility: property type 'System.Data.Entity.DbSet<assignment1.Beverage>' 
...
It could be the entity framework just isn't compatible with my computer or my current version of VS, since cis237inclass5 also throws weird errors (both my version and Dave's). But I'm not sure.
